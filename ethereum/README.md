...
a) to fund an account
b) to send a transaction
c) to execute a smart contract
~~d) to heat up your computer~~
...
a) greet: returns whatever string the contract was initiated with
b) kill: destroys the contrac
